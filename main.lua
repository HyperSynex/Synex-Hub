...
local function sendFeedback(msg)
    ...
    local data = {
        ...
        ["embeds"] = {{
            ...
            ["footer"] = {["text"] = "Hyper Feedback System | " .. os.date("%X")}
        }}
    }
    local jsonData = HttpService:JSONEncode(data)
    local httpRequest = (syn and syn.request) or (http and http.request) or http_request or (fluxus and fluxus.request) or request
...
local Themes = {
    Cyan = { MainBg = Color3.fromRGB(20, 20, 20), SidebarBg = Color3.fromRGB(25, 25, 30), ContentBg = Color3.fromRGB(32, 32, 36), Accent = Color3.fromRGB(0, 160, 255), TextPrimary = Color3.fromRGB(245, 245, 245), TextSecondary = Color3.fromRGB(180, 180, 180), Outline = Color3.fromRGB(50, 50, 60), ItemHover = Color3.fromRGB(40, 40, 50), Red = Color3.fromRGB(255, 75, 75), Green = Color3.fromRGB(75, 255, 120), Yellow = Color3.fromRGB(255, 200, 50) },
    Red = { MainBg = Color3.fromRGB(20, 20, 20), SidebarBg = Color3.fromRGB(30, 25, 25), ContentBg = Color3.fromRGB(36, 32, 32), Accent = Color3.fromRGB(255, 60, 60), TextPrimary = Color3.fromRGB(255, 245, 245), TextSecondary = Color3.fromRGB(180, 150, 150), Outline = Color3.fromRGB(60, 50, 50), ItemHover = Color3.fromRGB(50, 40, 40), Red = Color3.fromRGB(255, 75, 75), Green = Color3.fromRGB(75, 255, 120), Yellow = Color3.fromRGB(255, 200, 50) },
    Green = { MainBg = Color3.fromRGB(20, 20, 20), SidebarBg = Color3.fromRGB(25, 30, 25), ContentBg = Color3.fromRGB(32, 36, 32), Accent = Color3.fromRGB(60, 255, 100), TextPrimary = Color3.fromRGB(245, 255, 245), TextSecondary = Color3.fromRGB(150, 180, 150), Outline = Color3.fromRGB(50, 60, 50), ItemHover = Color3.fromRGB(40, 50, 40), Red = Color3.fromRGB(255, 75, 75), Green = Color3.fromRGB(75, 255, 120), Yellow = Color3.fromRGB(255, 200, 50) },
    Purple = { MainBg = Color3.fromRGB(20, 20, 20), SidebarBg = Color3.fromRGB(28, 25, 30), ContentBg = Color3.fromRGB(34, 32, 36), Accent = Color3.fromRGB(170, 0, 255), TextPrimary = Color3.fromRGB(250, 245, 255), TextSecondary = Color3.fromRGB(170, 160, 180), Outline = Color3.fromRGB(55, 50, 60), ItemHover = Color3.fromRGB(45, 40, 50), Red = Color3.fromRGB(255, 75, 75), Green = Color3.fromRGB(75, 255, 120), Yellow = Color3.fromRGB(255, 200, 50) },
    Orange = { MainBg = Color3.fromRGB(20, 20, 20), SidebarBg = Color3.fromRGB(30, 28, 25), ContentBg = Color3.fromRGB(36, 34, 32), Accent = Color3.fromRGB(255, 140, 0), TextPrimary = Color3.fromRGB(255, 250, 245), TextSecondary = Color3.fromRGB(180, 170, 160), Outline = Color3.fromRGB(60, 55, 50), ItemHover = Color3.fromRGB(50, 45, 40), Red = Color3.fromRGB(255, 75, 75), Green = Color3.fromRGB(75, 255, 120), Yellow = Color3.fromRGB(255, 200, 50) },
    Midnight = { MainBg = Color3.fromRGB(10, 10, 15), SidebarBg = Color3.fromRGB(15, 15, 20), ContentBg = Color3.fromRGB(20, 20, 25), Accent = Color3.fromRGB(100, 100, 255), TextPrimary = Color3.fromRGB(200, 200, 255), TextSecondary = Color3.fromRGB(120, 120, 160), Outline = Color3.fromRGB(30, 30, 50), ItemHover = Color3.fromRGB(25, 25, 40), Red = Color3.fromRGB(255, 75, 75), Green = Color3.fromRGB(75, 255, 120), Yellow = Color3.fromRGB(255, 200, 50) },
    Synapse = { MainBg = Color3.fromRGB(40, 40, 40), SidebarBg = Color3.fromRGB(50, 50, 50), ContentBg = Color3.fromRGB(45, 45, 45), Accent = Color3.fromRGB(255, 255, 255), TextPrimary = Color3.fromRGB(255, 255, 255), TextSecondary = Color3.fromRGB(200, 200, 200), Outline = Color3.fromRGB(70, 70, 70), ItemHover = Color3.fromRGB(60, 60, 60), Red = Color3.fromRGB(255, 75, 75), Green = Color3.fromRGB(75, 255, 120), Yellow = Color3.fromRGB(255, 200, 50) },
    Gold = { MainBg = Color3.fromRGB(25, 25, 25), SidebarBg = Color3.fromRGB(30, 30, 30), ContentBg = Color3.fromRGB(35, 35, 35), Accent = Color3.fromRGB(255, 215, 0), TextPrimary = Color3.fromRGB(255, 255, 240), TextSecondary = Color3.fromRGB(189, 183, 107), Outline = Color3.fromRGB(70, 65, 50), ItemHover = Color3.fromRGB(50, 50, 40), Red = Color3.fromRGB(255, 80, 80), Green = Color3.fromRGB(80, 255, 80), Yellow = Color3.fromRGB(255, 215, 0) },
    Toxic = { MainBg = Color3.fromRGB(10, 15, 10), SidebarBg = Color3.fromRGB(15, 20, 15), ContentBg = Color3.fromRGB(20, 25, 20), Accent = Color3.fromRGB(124, 252, 0), TextPrimary = Color3.fromRGB(200, 255, 200), TextSecondary = Color3.fromRGB(100, 150, 100), Outline = Color3.fromRGB(30, 50, 30), ItemHover = Color3.fromRGB(25, 35, 25), Red = Color3.fromRGB(255, 50, 50), Green = Color3.fromRGB(50, 255, 50), Yellow = Color3.fromRGB(255, 255, 50) },
    CottonCandy = { MainBg = Color3.fromRGB(255, 240, 245), SidebarBg = Color3.fromRGB(255, 228, 225), ContentBg = Color3.fromRGB(240, 248, 255), Accent = Color3.fromRGB(255, 105, 180), TextPrimary = Color3.fromRGB(70, 70, 90), TextSecondary = Color3.fromRGB(100, 100, 120), Outline = Color3.fromRGB(200, 200, 220), ItemHover = Color3.fromRGB(230, 230, 250), Red = Color3.fromRGB(255, 100, 100), Green = Color3.fromRGB(100, 200, 100), Yellow = Color3.fromRGB(255, 200, 100) },
    Ocean = { MainBg = Color3.fromRGB(10, 25, 40), SidebarBg = Color3.fromRGB(15, 35, 55), ContentBg = Color3.fromRGB(20, 45, 70), Accent = Color3.fromRGB(0, 190, 255), TextPrimary = Color3.fromRGB(220, 240, 255), TextSecondary = Color3.fromRGB(100, 140, 170), Outline = Color3.fromRGB(30, 60, 90), ItemHover = Color3.fromRGB(25, 55, 85), Red = Color3.fromRGB(255, 80, 80), Green = Color3.fromRGB(80, 255, 150), Yellow = Color3.fromRGB(255, 220, 80) },
    Vaporwave = { MainBg = Color3.fromRGB(20, 10, 30), SidebarBg = Color3.fromRGB(30, 15, 40), ContentBg = Color3.fromRGB(40, 20, 50), Accent = Color3.fromRGB(255, 0, 255), TextPrimary = Color3.fromRGB(0, 255, 255), TextSecondary = Color3.fromRGB(255, 150, 255), Outline = Color3.fromRGB(60, 30, 80), ItemHover = Color3.fromRGB(50, 25, 60), Red = Color3.fromRGB(255, 50, 100), Green = Color3.fromRGB(50, 255, 150), Yellow = Color3.fromRGB(255, 255, 100) },
    Dracula = { MainBg = Color3.fromRGB(40, 42, 54), SidebarBg = Color3.fromRGB(68, 71, 90), ContentBg = Color3.fromRGB(56, 58, 89), Accent = Color3.fromRGB(255, 121, 198), TextPrimary = Color3.fromRGB(248, 248, 242), TextSecondary = Color3.fromRGB(98, 114, 164), Outline = Color3.fromRGB(98, 114, 164), ItemHover = Color3.fromRGB(80, 80, 100), Red = Color3.fromRGB(255, 85, 85), Green = Color3.fromRGB(80, 250, 123), Yellow = Color3.fromRGB(241, 250, 140) }
}
...
local function createLayout(parent)
    ...
    if parent:IsA("ScrollingFrame") then
        layout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
            parent.CanvasSize = UDim2.new(0, 0, 0, layout.AbsoluteContentSize.Y + 80)
        end)
    end
